...
use crate::{
  action::CopyTarget, cli::args::ModifierArgs, printer::ListPrinter, proc::Interpreter,
  ptrace::InspectError, timestamp::Timestamp,
};
...
use super::{EventStatus, ExecEvent, OutputMsg, RuntimeModifier, TracerEventMessage};

impl super::TracerEventDetails {
  pub fn to_tui_line(
    &self,
